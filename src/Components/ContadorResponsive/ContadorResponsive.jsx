            ...
            <Container  minH={{base:'300px', sm:'100px'}} mt={{base:'10px', md:'20px'}}>
                <Grid templateColumns={{base:'repeat(2,1fr)',md:'repeat(3,1fr)'}} rowGap={4} gap={4}>
                    ...
                    <motion.div className="box" whileTap={{scale: 1.2}} whileHover={{ scale: 1.05 }}
                        ...
                        outlineColor={'red'} color={'red'} _hover={{bg:'rgb(248, 134, 114)', color:'white'}} isDisabled={contador <= 0}><FaMinusSquare  /></Button>
                        </motion.div></GridItem>
                    <GridItem colSpan={{base:2 ,md:1}} order={{base:2 ,md:1}}>
                    <motion.div className="box" whileTap={{scale: 1.2}} whileHover={{ scale: 1.05 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }} >     
                        <Button w={'full'}  onClick={borrar} padding={'10px 25px'} borderRadius={'10px'} 
                        bg={'white'} outlineOffset={'2'} outlineColor={'gray'} color={'gray'} _hover={{bg:'rgb(184, 184, 184)', color:'white'}} isDisabled={contador <= 0}><FaTrash/></Button>
                        </motion.div></GridItem>
                    <GridItem colSpan={1} order={{base:1 ,md:2}}>    
                    <motion.div className="box" whileTap={{scale: 1.2}} whileHover={{ scale: 1.05 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }} >
                       <Button w={'full'}  onClick={sumar} padding={'10px 25px'} borderRadius={'10px'} bg={'white'} outlineOffset={'2'} outlineColor={'green'} color={'green'} _hover={{bg:'rgb(139, 224, 53)', color:'white'}}><FaPlusSquare/></Button>
                       </motion.div></GridItem>
                </Grid>  
            </Container>
